...
def expected_single_form_response
  {
    ...
    "To apply to use our crowdfunding training program, you must be affiliated with Colevester University. Please read and accept the terms below to proceed."=>true,
    ...
    "Are these funds for a research-related activity?"=>true,
    "What type of project is your fundraising intended to support?"=>"Engineering, Student Organization",
    "Do you have a deadline for funds to be available?"=>true,
